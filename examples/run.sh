...
KMP_INIT_AT_FORK=FALSE python ppo_tanh.py --env_id='Swimmer-v2' --ent_coef=0 --save_dir='tanh_data' &
KMP_INIT_AT_FORK=FALSE python ppo_tanh.py --env_id='Swimmer-v2' --seed=234 --ent_coef=0 --save_dir='tanh_data' &
KMP_INIT_AT_FORK=FALSE python ppo_tanh.py --env_id='HalfCheetah-v2' --ent_coef=0 --save_dir='tanh_data' &
KMP_INIT_AT_FORK=FALSE python ppo_tanh.py --env_id='HalfCheetah-v2' --ent_coef=0 --seed=234 --save_dir='tanh_data' &
